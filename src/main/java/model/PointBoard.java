...
public class PointBoard {
    ...
    public int getCollectedEcho() {return collectedEcho;}
    public int getBankedEcho(){return bankedEcho;}
    public int[] getTrophiesIndexToken() {return trophiesIndexToken;}
    public int[][] getTrophiesBoard(){ return trophiesBoard;}
